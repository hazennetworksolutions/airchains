...
junctiond config set client node tcp://localhost:${AIRCHAINS_PORT}657
...
s%:6065%:${AIRCHAINS_PORT}065%g" $HOME/.junctiond/config/app.toml
...
s%:26660%:${AIRCHAINS_PORT}660%g" $HOME/.junctiond/config/config.toml
